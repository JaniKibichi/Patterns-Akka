...
import com.github.janikibichi.learnakka.patterns.MasterWorkPulling._
import com.github.janikibichi.learnakka.patterns.WorkerWorkPulling._
    ...
    case work: Work =>
      ...
      workers.find(_._2 == Idle) match {
        case Some((worker, _)) =>
          ...
          log.info(s"Work receieved and found idle worker. Submitting [$nextWork] to [$worker]")
        case None =>
